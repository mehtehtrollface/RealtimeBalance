...
Shoes.app(title: "MOBAGame Realtime Balance", width: 800, height: 600) do
	...
	@abilitytab = stack(margin:8) do
		...
		@ratio1type.change do |selection|
			case selection.text
			when "Ability Power" 
				js["ability"][selectedab]["ratio1type"] = "ap"
			when "Total Attack Damage"
				js["ability"][selectedab]["ratio1type"] = "ad"
			when "Max Health"
				js["ability"][selectedab]["ratio1type"] = "hp"
			when "Bonus Attack Damage"
				js["ability"][selectedab]["ratio1type"] = "bad"
			when "Armor"
				js["ability"][selectedab]["ratio1type"] = "ar"
			when "Magic Resist"
				js["ability"][selectedab]["ratio1type"] = "mr"
			when "Health Regen"
				js["ability"][selectedab]["ratio1type"] = "hr"
			when "Movespeed"
				js["ability"][selectedab]["ratio1type"] = "ms"
			when "Attack Speed"
				js["ability"][selectedab]["ratio1type"] = "as"
			when "Lifesteal"
				js["ability"][selectedab]["ratio1type"] = "ls"
			when "Spell Vamp"
				js["ability"][selectedab]["ratio1type"] = "sv"
			when "Max Mana"
				js["ability"][selectedab]["ratio1type"] = "mana"
			when "Mana Regen"
				js["ability"][selectedab]["ratio1type"] = "mreg"
			when "Armor Pen"
				js["ability"][selectedab]["ratio1type"] = "arpen"
			when "Magic Pen"
				js["ability"][selectedab]["ratio1type"] = "mrpen"
			when "% Armor Pen"
				js["ability"][selectedab]["ratio1type"] = "perarpen"
			when "% Magic Pen"
				js["ability"][selectedab]["ratio1type"] = "permrpen"
			when "Cooldown Reduction"
				js["ability"][selectedab]["ratio1type"] = "cdr"
			when "Crit Chance"
				js["ability"][selectedab]["ratio1type"] = "crit"
			when "Tenacity"
				js["ability"][selectedab]["ratio1type"] = "ten"
			else
				puts "Bruh"
			end
		end
		...
		@ratio2type.change do |selection|
			case selection.text
			when "Ability Power" 
				js["ability"][selectedab]["ratio2type"] = "ap"
			when "Total Attack Damage"
				js["ability"][selectedab]["ratio2type"] = "ad"
			when "Max Health"
				js["ability"][selectedab]["ratio2type"] = "hp"
			when "Bonus Attack Damage"
				js["ability"][selectedab]["ratio2type"] = "bad"
			when "Armor"
				js["ability"][selectedab]["ratio2type"] = "ar"
			when "Magic Resist"
				js["ability"][selectedab]["ratio2type"] = "mr"
			when "Health Regen"
				js["ability"][selectedab]["ratio2type"] = "hr"
			when "Movespeed"
				js["ability"][selectedab]["ratio2type"] = "ms"
			when "Attack Speed"
				js["ability"][selectedab]["ratio2type"] = "as"
			when "Lifesteal"
				js["ability"][selectedab]["ratio2type"] = "ls"
			when "Spell Vamp"
				js["ability"][selectedab]["ratio2type"] = "sv"
			when "Max Mana"
				js["ability"][selectedab]["ratio2type"] = "mana"
			when "Mana Regen"
				js["ability"][selectedab]["ratio2type"] = "mreg"
			when "Armor Pen"
				js["ability"][selectedab]["ratio2type"] = "arpen"
			when "Magic Pen"
				js["ability"][selectedab]["ratio2type"] = "mrpen"
			when "% Armor Pen"
				js["ability"][selectedab]["ratio2type"] = "perarpen"
			when "% Magic Pen"
				js["ability"][selectedab]["ratio2type"] = "permrpen"
			when "Cooldown Reduction"
				js["ability"][selectedab]["ratio2type"] = "cdr"
			when "Crit Chance"
				js["ability"][selectedab]["ratio2type"] = "crit"
			when "Tenacity"
				js["ability"][selectedab]["ratio2type"] = "ten"
			else
				puts "Bruh"
			end
		end
